            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        <div class="shrink-0">
                            <img class="h-8 w-8" src="{{ asset('assets\images\LOGO PGH.png') }}" alt="Your Company">
                        </div>
                            ...
                            <div class="relative ml-3">
                                <div>
                                    <button type="button"
                                        ...
                                        <img class="h-8 w-8 rounded-full" src="{{ asset('assets\images\9k.png') }}"
                                            alt="">
                                    </button>
                                </div>
                ...
                <div class="border-t border-gray-700 pb-3 pt-4">
                    <div class="flex items-center px-5">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="text-sm font-medium text-gray-400">ajam@pgh.com</div>
                        </div>
                        <button type="button"
