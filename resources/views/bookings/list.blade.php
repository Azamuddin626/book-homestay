                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        ...
                        <div>
                            <label for="edit_tujuan"
                                ...
                                Menyewa</label>
                            <select id="edit_tujuan" name="tujuan"
                        ...
                        <!-- Nama Penyewa -->
                        <div>
                            <label for="edit_nama_penyewa"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama
                                Penyewa</label>
                            <input type="text" id="edit_nama_penyewa" name="nama_penyewa"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                required>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input datepicker datepicker-format="yyyy-mm-dd" type="text" id="edit_check_in"
                                    name="check_in"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input datepicker datepicker-format="yyyy-mm-dd" type="text" id="edit_check_out"
                                    name="check_out"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Select date" required>
                            </div>
                        ...
                        <div>
                            <label for="edit_kanak"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Bilangan Penyewa
                                Kanak-kanak</label>
                            <input type="number" id="edit_kanak" name="kanak"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                min="0" required>
                        </div>
                        ...
                        <!-- Homestay -->
                        <div class="md:col-span-2">
                            <label for="edit_homestay"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pilih
                                Homestay</label>
                            <select id="edit_homestay" name="homestay"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                required>
