...
@section('content')
    <div class="container mx-auto p-4">
        ...
        @if (session('success'))
            <div class="p-4 mb-4 text-nature-fern rounded-lg bg-nature-leaf dark:bg-gray-800 dark:text-green-400"
                role="alert">
                {{ session('success') }}
            </div>
        @endif
                            ...
                            <div class="grid gap-6 mb-6 md:grid-cols-2">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <select id="homestay" name="homestay"
                                        ...
                                        required>
                                        <option value="">Sila Pilih</option>
                                        <option value="Rumah Kayu Merbau"
                                            {{ old('homestay') == 'Rumah Kayu Merbau' ? 'selected' : '' }}>Rumah Kayu
                                            Merbau</option>
                                        <option value="Rumah Batu Jati"
                                            {{ old('homestay') == 'Rumah Batu Jati' ? 'selected' : '' }}>Rumah Batu Jati
                                        </option>
                                        <option value="Rumah Batu Meranti"
                                            {{ old('homestay') == 'Rumah Batu Meranti' ? 'selected' : '' }}>Rumah Batu
                                            Meranti</option>
                                        <option value="Semua Rumah"
                                            {{ old('homestay') == 'Semua Rumah' ? 'selected' : '' }}>Semua Rumah</option>
                                    </select>
                                    @error('homestay')
                                        <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                                    @enderror
