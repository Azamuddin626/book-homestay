        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                ...
                <button data-collapse-toggle="navbar-menu" type="button"
                    class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-nature-bark rounded-lg md:hidden hover:bg-nature-clay focus:outline-none focus:ring-2 focus:ring-nature-moss dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
